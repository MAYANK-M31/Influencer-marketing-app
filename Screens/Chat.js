...
import { TouchableRipple, Modal, TextInput } from 'react-native-paper';
...
const Chat = ({ navigation }) => {
    ...
    //         containerStyle={{backgroundColor:"white",height:45,borderRadius:50,marginBottom:10,padding:0,paddingHorizontal:5,marginHorizontal:8}}
    //         />
    //     )
    // }
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: "white" }} >
            ...
            <View style={{ height: 20, width: 50, backgroundColor: "white", borderWidth: 1, borderRadius: 10, borderColor: "#01e491", position: "absolute", alignSelf: "center", top: 55, zIndex: 1, justifyContent: "center", alignItems: "center" }}>
