      ...
      <SafeAreaView style={{ height: HEIGHT, backgroundColor: "white" }} >
        ...
        <ScrollView showsVerticalScrollIndicator={false} scrollEventThrottle={16} contentContainerStyle={{ paddingBottom: 100 }} >
          ...
          <View style={style.cardbottom} >
            ...
            <Text style={style.category} >{result.category}</Text>
          </View>
          ...
          <View style={style.buttondiv} >
            ...
            <TouchableOpacity activeOpacity={0.9} onPress={() => navigation.navigate("EditProfileStack",{screen:"EditProfile",params:{budget:[result.minrange,result.maxrange],city:result.city,paymode:result.paymode,age:result.age,name:result.name,category:result.category,instaconnected:instaconnected,youtubeconnected:youtubeconnected}}) } style={style.button2} >
          ...
          <View style={style.about} >
            <View style={style.aboutdiv}>
              <Text style={{ fontSize: 14, fontWeight: "bold", color: "#404852", textTransform: "capitalize" }}>{result.minrange}-{result.maxrange}K</Text>
              <Text style={{ fontSize: 13, fontWeight: "normal", color: "grey" }}>Budget</Text>
            </View>
            <View style={style.aboutdiv}>
              <Text style={{ fontSize: 14, fontWeight: "bold", color: "#404852", textTransform: "capitalize" }}>{result.city}</Text>
            ...
            <View style={style.aboutdiv}>
              {result.paymode == "both" ?
                ...
                :
                <>
                  <Text style={{ fontSize: 14, fontWeight: "bold", color: "#404852", textTransform: "capitalize", textTransform: "capitalize" }}>{result.paymode}</Text>
            ...
            <View style={style.aboutdiv}>
              <Text style={{ fontSize: 14, fontWeight: "bold", color: "#404852", textTransform: "capitalize" }}>{result.age}</Text>
