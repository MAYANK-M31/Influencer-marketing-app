...
const BrandSocialConnect = ({ navigation, route }) => {
    ...
    return (
        <>
            ...
            <SafeAreaView style={style.container}>
                ...
                <Text style={{ alignSelf: "center", fontSize: 14, fontWeight: "100", color: "#1e87fd", position: "absolute", bottom: 150, left: 28 }} >Note : This Will Integrate Your Account With Your </Text>
                <Text style={{ alignSelf: "center", fontSize: 14, fontWeight: "100", color: "#1e87fd", position: "absolute", bottom: 132, left: 26 }} > Instagram Page and YouTube Account </Text>
                ...
                <TouchableOpacity disabled={disable} onPress={() => { submit() }} style={{
                    ...
                    borderColor: "#1e87fd", borderWidth: 1, borderRadius: 50, position: "absolute", bottom: 45
                }} >
